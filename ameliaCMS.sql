...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2017 a las 05:52:50
...
--
-- Base de datos: `ameliaCMS`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `taction`
--
...
--
-- Volcado de datos para la tabla `taction`
--

INSERT INTO `taction` (`idaction`, `name`, `function`, `idicon`, `status`) VALUES
(1, 'Agregar', 1, 2, '1'),
(2, 'Editar', 2, 71, '1'),
(3, 'Consultar', 3, 11, '1'),
(4, 'Activar', 4, 20, '1'),
...
--
-- Estructura de tabla para la tabla `taddress`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=1503 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `taddress`
--

INSERT INTO `taddress` (`idaddress`, `idfather`, `name`, `status`) VALUES
(1, 0, 'VENEZUELA', '1'),
(2, 1, 'DTTO. CAPITAL', '1'),
(3, 1, 'ANZOATEGUI', '1'),
(4, 1, 'APURE', '1'),
...
--
-- Estructura de tabla para la tabla `tcharge`
--

CREATE TABLE IF NOT EXISTS `tcharge` (
...
--
-- Volcado de datos para la tabla `tcharge`
--

INSERT INTO `tcharge` (`idcharge`, `name`, `status`) VALUES
(1, 'Administrador', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tconfiguration`
--

CREATE TABLE IF NOT EXISTS `tconfiguration` (
  `number_question_answer` int(11) DEFAULT NULL,
  `login` int(11) NOT NULL,
  `new_password_sent_email` int(11) NOT NULL,
  `email_host` text NOT NULL,
  `email_port` varchar(5) NOT NULL,
  `email_security_smtp` char(1) NOT NULL,
  `email_type_security_smtp` varchar(3) NOT NULL,
  `email_user` text NOT NULL,
  `email_password` text NOT NULL,
  `email_subject` text NOT NULL,
  `email_message` text NOT NULL,
  `number_days_password_diferrence` int(11) NOT NULL,
  `number_answer_allowed` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `tconfiguration`
--
...
--
-- Estructura de tabla para la tabla `tdcharge_service_action`
--

CREATE TABLE IF NOT EXISTS `tdcharge_service_action` (
...
--
-- Volcado de datos para la tabla `tdcharge_service_action`
--

INSERT INTO `tdcharge_service_action` (`idcharge_service_action`, `idcharge`, `idservice`, `idaction`) VALUES
(5397, 1, 22, 1),
(5398, 1, 22, 2),
(5399, 1, 22, 3),
(5400, 1, 22, 4),
...
--
-- Estructura de tabla para la tabla `tdpassword`
--

CREATE TABLE IF NOT EXISTS `tdpassword` (
...
--
-- Volcado de datos para la tabla `tdpassword`
--

INSERT INTO `tdpassword` (`idpassword`, `iduser`, `password`, `creation_date`, `status`) VALUES
(1, 1, '$2y$10$FBRD0fqDXtovuUdTk1gUf.ijflzRm3NklCVCx3WMzblw.AL7mz.sm', '2017-08-05 03:50:30', '0'),
(4, 2, '$2y$10$FBRD0fqDXtovuUdTk1gUf.ijflzRm3NklCVCx3WMzblw.AL7mz.sm', '2017-08-03 17:14:49', '0'),
(5, 2, '$2y$10$RsojQKejC8UG86wm5tbyueasfHzjduKdpSQ0XtQEEdW2zvw5zpAKq', '2017-08-03 17:15:33', '0'),
(6, 2, '$2y$10$o/fAOi85v6pgJjuFg4P8X.7s1x8Y3wvUqqDED3CV6F/D8OJfHqvKm', '2017-08-03 19:28:43', '0'),
(7, 2, '$2y$10$ehcM.29r3R3lwJSeBXZZzeLDAADmD5gQWVElRC14rbEDfUSI7lQzq', '2017-08-03 19:28:43', '1'),
(8, 1, '$2y$10$GET6Re5H1.dvxTuS5iyQE.MfnttfsdtZCwuYBlytObmFrxOGybH0O', '2017-08-05 03:50:30', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tdquestion_answer`
--

CREATE TABLE IF NOT EXISTS `tdquestion_answer` (
...
--
-- Volcado de datos para la tabla `tdquestion_answer`
--

INSERT INTO `tdquestion_answer` (`idquestion_answer`, `iduser`, `question`, `answer`) VALUES
(9, 1, 'admin', '$2y$10$QDPohTJsfqAZVKTRMyJToeOUfMWkhq3kNXV.R5vZVQNYeWtqT1WZq'),
(10, 1, 'admin', '$2y$10$MZzzv6igRJgGv.94eBNsLuxqR8NS5zDj5nHbyAVnf09VAVkN76oNu');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tdservice_action`
--

CREATE TABLE IF NOT EXISTS `tdservice_action` (
...
--
-- Volcado de datos para la tabla `tdservice_action`
--

INSERT INTO `tdservice_action` (`idservice_action`, `idservice`, `idaction`) VALUES
(1, 2, 1),
(2, 2, 2),
(3, 2, 3),
(4, 2, 4),
...
--
-- Estructura de tabla para la tabla `tethnicity`
--

CREATE TABLE IF NOT EXISTS `tethnicity` (
...
--
-- Volcado de datos para la tabla `tethnicity`
--

INSERT INTO `tethnicity` (`idethnicity`, `name`, `status`) VALUES
(1, 'NINGUNO', '1'),
(2, 'ACAHUAYO', '1'),
...
--
-- Estructura de tabla para la tabla `tgallery`
--
...
--
-- Volcado de datos para la tabla `tgallery`
--

INSERT INTO `tgallery` (`idgallery`, `iduser`, `src`, `title`, `legend`, `alternative`, `description`, `date_created`) VALUES
(1, 1, 'uploads/gallery/20170803084407icon.png', '', '', '', '', '2017-08-03');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ticon`
--

CREATE TABLE IF NOT EXISTS `ticon` (
`idicon` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `ticon`
--

INSERT INTO `ticon` (`idicon`, `class`, `name`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `tlog_access`
--

CREATE TABLE IF NOT EXISTS `tlog_access` (
...
--
-- Estructura de tabla para la tabla `tlog_movement`
--

CREATE TABLE IF NOT EXISTS `tlog_movement` (
...
--
-- Estructura de tabla para la tabla `tlog_report`
--

CREATE TABLE IF NOT EXISTS `tlog_report` (
...
--
-- Estructura de tabla para la tabla `tnationality`
--
...
--
-- Volcado de datos para la tabla `tnationality`
--

INSERT INTO `tnationality` (`idnationality`, `name_one`, `name_two`, `status`) VALUES
(1, 'V', 'Venezolano', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `torganization`
--
...
--
-- Volcado de datos para la tabla `torganization`
--

INSERT INTO `torganization` (`name_one`, `name_two`, `email`, `description`, `idgallery_header`, `idgallery_favicon`, `address`, `rights`, `phone_one`, `phone_two`, `phone_three`) VALUES
('AmeliaCMS', 'AmeliaCMS ', 'augustoalvarez05@gmail.com', 'Version Beta', 0, 2, 'av 36 entre 22 y 23', 'Todos los derechos reservados 2017', '04245370954', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tpage`
--
...
INSERT INTO `tperson` (`idperson`, `idnationality`, `idethnicity`, `idcharge`, `image`, `identification_card`, `name_one`, `name_two`, `last_name_one`, `last_name_two`, `sex`, `email`, `birth_date`, `birth_place`, `idaddress`, `address`, `phone_one`, `phone_two`, `status`) VALUES
(1, 1, 1, 1, '', '25026527', 'Augusto', 'Sergio', 'Alvarez', 'Gomez', 'M', 'augustoalvarez05@gmail.com', '1994-10-31', 'Acarigua', 1036, 'acargiua', '04245370954', '04143540082', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tpost`
--
...
--
-- Volcado de datos para la tabla `tpost`
--

INSERT INTO `tpost` (`idpost`, `url`, `name`, `color`, `idgallery`, `content`, `iduser`, `date_created`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `tservice`
--
...
--
-- Volcado de datos para la tabla `tservice`
--

INSERT INTO `tservice` (`idservice`, `idfather`, `name`, `url`, `idicon`, `color`, `ordered`, `status`) VALUES
(1, 0, 'Seguridad y config.', '', 139, '', 1, '1'),
(2, 1, 'Cargos', 'charge', 591, '', 4, '1'),
(3, 1, 'Acciones', 'action', 108, 'F5F5F5', 7, '1'),
(4, 1, 'Servicios', 'service', 26, '', 4, '1'),
(5, 1, 'Etnias', 'ethnicity', 964, '', 9, '1'),
(6, 1, 'Nacionalidades', 'nationality', 179, '', 8, '1'),
(8, 1, 'Iconos', 'icon', 8, '', 10, '1'),
(9, 0, 'Localidades', '', 438, '', 11, '1'),
(10, 9, 'Parroquias', 'parish', 327, '', 4, '1'),
(11, 9, 'Municipios', 'municipality', 328, '', 3, '1'),
(12, 9, 'Estados', 'state', 328, '', 2, '1'),
(13, 9, 'Paises', 'country', 328, '', 1, '1'),
(14, 1, 'Personas', 'person', 445, '', 3, '1'),
(15, 1, 'Usuarios', 'user', 445, '', 2, '1'),
(16, 0, 'Reportes', '', 392, '', 16, '1'),
(17, 16, 'Bitacora de acceso', 'log_access', 801, 'F5F5F5', 19, '1'),
(18, 16, 'Bitacora de movimientos', 'log_movement', 803, 'F5F5F5', 17, '1'),
(19, 16, 'Bitacora de reportes', 'log_report', 802, 'F5F5F5', 18, '1'),
(20, 1, 'Organizacion', 'organization', 28, '', 1, '1'),
(21, 0, 'Blog', '', 50, '', 0, '1'),
(22, 21, 'Publicaciones', 'post', 782, '', 0, '1'),
(23, 21, 'Paginas', 'page', 29, 'F5F5F5', 0, '1'),
(24, 21, 'Redes sociales', 'social_network', 848, 'F5F5F5', 0, '1'),
(25, 16, 'Listados', 'list_report', 321, 'F5F5F5', 0, '1'),
(26, 1, 'Configuracion', 'configuration', 124, 'F5F5F5', 0, '1'),
(27, 21, 'Galeria', 'gallery', 327, 'F5F5F5', 0, '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tsocial_network`
--

CREATE TABLE IF NOT EXISTS `tsocial_network` (
...
--
-- Volcado de datos para la tabla `tsocial_network`
--

INSERT INTO `tsocial_network` (`idsocial_network`, `name`, `url`, `idicon`, `status`) VALUES
(1, 'Facebook', 'http://www.facebook.com', 395, '1'),
(2, 'Twitter', 'www.twitter.com', 418, '1');
...
INSERT INTO `tuser` (`iduser`, `idperson`, `name`, `failed_attempts`, `initiated`, `note`, `status`) VALUES
(1, 1, 'admin', 0, 1, '', '1');
...
--
-- Indices de la tabla `taction`
--
ALTER TABLE `taction`
 ADD PRIMARY KEY (`idaction`);

--
-- Indices de la tabla `taddress`
--
ALTER TABLE `taddress`
 ADD PRIMARY KEY (`idaddress`);

--
-- Indices de la tabla `tcharge`
--
ALTER TABLE `tcharge`
 ADD PRIMARY KEY (`idcharge`);

--
-- Indices de la tabla `tdcharge_service_action`
--
ALTER TABLE `tdcharge_service_action`
 ADD PRIMARY KEY (`idcharge_service_action`);

--
-- Indices de la tabla `tdpassword`
--
ALTER TABLE `tdpassword`
 ADD PRIMARY KEY (`idpassword`);

--
-- Indices de la tabla `tdquestion_answer`
--
ALTER TABLE `tdquestion_answer`
 ADD PRIMARY KEY (`idquestion_answer`);

--
-- Indices de la tabla `tdservice_action`
--
ALTER TABLE `tdservice_action`
 ADD PRIMARY KEY (`idservice_action`);

--
-- Indices de la tabla `tethnicity`
--
ALTER TABLE `tethnicity`
 ADD PRIMARY KEY (`idethnicity`);

--
-- Indices de la tabla `tgallery`
--
ALTER TABLE `tgallery`
 ADD PRIMARY KEY (`idgallery`);

--
-- Indices de la tabla `ticon`
--
ALTER TABLE `ticon`
 ADD PRIMARY KEY (`idicon`);

--
-- Indices de la tabla `tlog_access`
--
ALTER TABLE `tlog_access`
 ADD PRIMARY KEY (`idlog_access`);

--
-- Indices de la tabla `tlog_movement`
--
ALTER TABLE `tlog_movement`
 ADD PRIMARY KEY (`idlog_movement`);

--
-- Indices de la tabla `tlog_report`
--
ALTER TABLE `tlog_report`
 ADD PRIMARY KEY (`idlog_report`);

--
-- Indices de la tabla `tnationality`
--
ALTER TABLE `tnationality`
 ADD PRIMARY KEY (`idnationality`);

--
-- Indices de la tabla `tpage`
--
ALTER TABLE `tpage`
...
--
-- Indices de la tabla `tpost`
--
ALTER TABLE `tpost`
 ADD PRIMARY KEY (`idpost`);

--
-- Indices de la tabla `tservice`
--
ALTER TABLE `tservice`
 ADD PRIMARY KEY (`idservice`);

--
-- Indices de la tabla `tsocial_network`
--
ALTER TABLE `tsocial_network`
...
--
-- AUTO_INCREMENT de la tabla `taction`
--
ALTER TABLE `taction`
MODIFY `idaction` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `taddress`
--
ALTER TABLE `taddress`
MODIFY `idaddress` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1503;
--
-- AUTO_INCREMENT de la tabla `tcharge`
--
ALTER TABLE `tcharge`
MODIFY `idcharge` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tdcharge_service_action`
--
ALTER TABLE `tdcharge_service_action`
MODIFY `idcharge_service_action` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5513;
--
-- AUTO_INCREMENT de la tabla `tdpassword`
--
ALTER TABLE `tdpassword`
MODIFY `idpassword` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `tdquestion_answer`
--
ALTER TABLE `tdquestion_answer`
MODIFY `idquestion_answer` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `tdservice_action`
--
ALTER TABLE `tdservice_action`
MODIFY `idservice_action` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=229;
--
-- AUTO_INCREMENT de la tabla `tethnicity`
--
ALTER TABLE `tethnicity`
MODIFY `idethnicity` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT de la tabla `tgallery`
--
ALTER TABLE `tgallery`
MODIFY `idgallery` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `ticon`
--
ALTER TABLE `ticon`
MODIFY `idicon` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=990;
--
-- AUTO_INCREMENT de la tabla `tlog_access`
--
ALTER TABLE `tlog_access`
MODIFY `idlog_access` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tlog_movement`
--
ALTER TABLE `tlog_movement`
MODIFY `idlog_movement` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `tlog_report`
--
ALTER TABLE `tlog_report`
MODIFY `idlog_report` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tnationality`
--
ALTER TABLE `tnationality`
MODIFY `idnationality` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tpage`
--
ALTER TABLE `tpage`
MODIFY `idpage` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tperson`
--
ALTER TABLE `tperson`
MODIFY `idperson` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tpost`
--
ALTER TABLE `tpost`
MODIFY `idpost` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tservice`
--
ALTER TABLE `tservice`
MODIFY `idservice` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT de la tabla `tsocial_network`
--
ALTER TABLE `tsocial_network`
