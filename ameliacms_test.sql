...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-08-2017 a las 06:44:05
...
--
-- Base de datos: `ameliacms_test`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acms_taction`
--
...
--
-- Volcado de datos para la tabla `acms_taction`
--

INSERT INTO `acms_taction` (`idaction`, `name`, `function`, `idicon`, `status`) VALUES
(1, 'Agregar', 1, 2, '1'),
(2, 'Editar', 2, 71, '1'),
(3, 'Consultar', 3, 11, '1'),
(4, 'Activar', 4, 20, '1'),
...
--
-- Estructura de tabla para la tabla `acms_taddress`
--
...
--
-- Volcado de datos para la tabla `acms_taddress`
--

INSERT INTO `acms_taddress` (`idaddress`, `idfather`, `name`, `status`) VALUES
(1, 0, 'VENEZUELA', '1'),
(2, 1, 'DTTO. CAPITAL', '1'),
(3, 1, 'ANZOATEGUI', '1'),
(4, 1, 'APURE', '1'),
...
(538, 76, 'PEDRO BRICEÃ‘O MENDEZ', '1'),
(539, 77, 'EL REAL', '1'),
(540, 77, 'LA LUZ', '1'),
(541, 77, 'OBISPOS', '1'),
(542, 77, 'LOS GUASIMITOS', '1'),
(543, 78, 'CIUDAD BOLIVIA', '1'),
(544, 78, 'IGNACIO BRICEÃ‘O', '1'),
(545, 78, 'PAEZ', '1'),
...
(1059, 238, 'SAN JOSE DE LA MONTAÃ‘A', '1'),
...
(1081, 244, 'PEÃ‘A BLANCA', '1'),
(1082, 245, 'CM. AGUA BLANCA', '1'),
(1083, 246, 'CM. PAPELON', '1'),
(1084, 246, 'CAÃ‘O DELGADITO', '1'),
...
(1177, 273, 'CARDENAS', '1'),
(1178, 273, 'POTOSI', '1'),
(1179, 273, 'JUAN PABLO PEÃ‘ALOZA', '1'),
...
--
-- Estructura de tabla para la tabla `acms_tcharge`
--
...
--
-- Volcado de datos para la tabla `acms_tcharge`
--

INSERT INTO `acms_tcharge` (`idcharge`, `name`, `status`) VALUES
(1, 'Administrador', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acms_tcontact`
--
...
--
-- Estructura de tabla para la tabla `acms_tdcharge_service_action`
--
...
--
-- Volcado de datos para la tabla `acms_tdcharge_service_action`
--
...
--
-- Estructura de tabla para la tabla `acms_tdpassword`
--
...
--
-- Volcado de datos para la tabla `acms_tdpassword`
--

INSERT INTO `acms_tdpassword` (`idpassword`, `iduser`, `password`, `creation_date`, `status`) VALUES
(1, 1, '$2y$10$aDzI0WoOWNUBtlqFg1e78OP.CISTk7OHFyyFBCs23JqC7cC/EV25m', '2017-08-11 00:11:01', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acms_tdquestion_answer`
--
...
--
-- Estructura de tabla para la tabla `acms_tdservice_action`
--
...
--
-- Volcado de datos para la tabla `acms_tdservice_action`
--
...
--
-- Estructura de tabla para la tabla `acms_tduser_service_ordered`
--
...
--
-- Estructura de tabla para la tabla `acms_tethnicity`
--
...
--
-- Volcado de datos para la tabla `acms_tethnicity`
--

INSERT INTO `acms_tethnicity` (`idethnicity`, `name`, `status`) VALUES
(1, 'NINGUNO', '1'),
(2, 'ACAHUAYO', '1'),
...
--
-- Estructura de tabla para la tabla `acms_tgallery`
--
...
CREATE TABLE `acms_tgallery` (
  ...
  `legend` text COLLATE utf8_spanish_ci NOT NULL,
  `alternative` text COLLATE utf8_spanish_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `acms_ticon`
--
...
--
-- Volcado de datos para la tabla `acms_ticon`
--

INSERT INTO `acms_ticon` (`idicon`, `class`, `name`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `acms_tlog_access`
--
...
CREATE TABLE `acms_tlog_access` (
  ...
  `operative_system` varchar(30) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `acms_tlog_access`
--

INSERT INTO `acms_tlog_access` (`idlog_access`, `name`, `message`, `ip`, `browser`, `date_created`, `operative_system`) VALUES
(1, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-12 22:18:36', 'WINDOWS 7'),
(2, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-12 22:22:14', 'WINDOWS 7'),
(3, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-12 23:21:25', 'WINDOWS 7'),
(4, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-12 23:22:07', 'WINDOWS 7'),
(5, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-12 23:26:15', 'WINDOWS 7'),
(6, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-12 23:26:28', 'WINDOWS 7'),
(7, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-12 23:55:23', 'WINDOWS 7'),
(8, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:00:51', 'WINDOWS 7'),
(9, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:01:05', 'WINDOWS 7'),
(10, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:01:31', 'WINDOWS 7'),
(11, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:02:00', 'WINDOWS 7'),
(12, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:02:41', 'WINDOWS 7'),
(13, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:02:51', 'WINDOWS 7'),
(14, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:04:37', 'WINDOWS 7'),
(15, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:04:49', 'WINDOWS 7'),
(16, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:08:53', 'WINDOWS 7'),
(17, 'admin', 'Sesion iniciada exitosamente', '::1', 'CHROME 60.0.3112.90', '2017-08-13 00:10:32', 'WINDOWS 7');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acms_tlog_movement`
--
...
--
-- Volcado de datos para la tabla `acms_tlog_movement`
--

INSERT INTO `acms_tlog_movement` (`idlog_movement`, `iduser`, `idaction`, `idservice`, `message`, `data`, `date_created`) VALUES
(1, 1, 3, 27, 'Listado', '', '2017-08-11 00:56:39'),
(2, 1, 3, 23, 'Listado', '', '2017-08-11 00:56:45'),
(3, 1, 3, 22, 'Listado', '', '2017-08-11 00:56:52'),
(4, 1, 3, 27, 'Listado', '', '2017-08-11 00:57:00'),
(5, 1, 3, 14, 'Listado', '', '2017-08-12 05:56:36'),
(6, 1, 3, 14, 'Listado', '', '2017-08-12 06:00:54'),
(7, 1, 3, 14, 'Listado', '', '2017-08-12 06:14:30'),
(8, 1, 3, 14, 'Listado', '', '2017-08-12 22:07:01'),
(9, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-12 22:07:06'),
(10, 1, 2, 14, 'toastr.info(\'Registro modificado exitosamente\',\'\',{progressBar:true})', '{CÃ³digo:\'1\',Nacionalidad:\'1\',Etnia:\'1\',Cargo:\'1\',Cedula:\'00000000\',Imagen de perfil:\'\',Primer nombre:\'Administrador\',Segundo nombre:\'\',Primer apellido:\'Root\',Segundo apellido:\'\',Sexo:\'F\',Correo electronico:\'augustoalvarez05@gmail.com\',Fecha de nacimiento:\'\',Lugar de nacimiento:\'asad\',Direccion:\'1036\',Direccion opcional:\'\',Primer telefono:\'\',Segundo telefono:\'\'}', '2017-08-12 22:07:26'),
(11, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-12 22:07:27'),
(12, 1, 3, 7, 'Listado', '', '2017-08-12 22:08:35'),
(13, 1, 3, 14, 'Listado', '', '2017-08-12 22:08:41'),
(14, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-12 22:08:45'),
(15, 1, 3, 14, 'Listado', '', '2017-08-12 22:10:11'),
(16, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-12 22:10:18'),
(17, 1, 3, 14, 'Listado', '', '2017-08-12 22:11:32'),
(18, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-12 22:11:35'),
(19, 1, 3, 14, 'Listado', '', '2017-08-13 00:04:58'),
(20, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-13 00:05:02'),
(21, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-13 00:06:06'),
(22, 1, 3, 14, 'Listado', '', '2017-08-13 00:06:20'),
(23, 1, 3, 14, 'Listado', '', '2017-08-13 00:06:26'),
(24, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-13 00:06:29'),
(25, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-13 00:06:49'),
(26, 1, 3, 14, 'Listado', '', '2017-08-13 00:09:02'),
(27, 1, 3, 14, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-13 00:09:05'),
(28, 1, 3, 2, 'Listado', '', '2017-08-13 00:10:41'),
(29, 1, 3, 4, 'Listado', '', '2017-08-13 00:10:58'),
(30, 1, 3, 4, 'Consultar', '{CÃ³digo:\'28\'}', '2017-08-13 00:11:01'),
(31, 1, 2, 4, 'toastr.info(\'Registro modificado exitosamente\',\'\',{progressBar:true})', '{CÃ³digo:\'28\',Modulo:\'21\',Nombre:\'Temas\',URL:\'theme\',Icono:\'710\',Color de letra:\'F5F5F5\'}', '2017-08-13 00:11:05'),
(32, 1, 3, 4, 'Consultar', '{CÃ³digo:\'28\'}', '2017-08-13 00:11:05'),
(33, 1, 3, 2, 'Listado', '', '2017-08-13 00:11:09'),
(34, 1, 3, 2, 'Listado', '', '2017-08-13 00:11:44'),
(35, 1, 3, 2, 'Listado', '', '2017-08-13 00:12:04'),
(36, 1, 3, 2, 'Listado', '', '2017-08-13 00:13:22'),
(37, 1, 3, 2, 'Listado', '', '2017-08-13 00:13:33'),
(38, 1, 3, 2, 'Listado', '', '2017-08-13 00:13:56'),
(39, 1, 3, 2, 'Listado', '', '2017-08-13 00:14:14'),
(40, 1, 3, 2, 'Listado', '', '2017-08-13 00:14:19'),
(41, 1, 3, 2, 'Listado', '', '2017-08-13 00:14:33'),
(42, 1, 3, 2, 'Listado', '', '2017-08-13 00:14:45'),
(43, 1, 3, 2, 'Listado', '', '2017-08-13 00:15:00'),
(44, 1, 3, 2, 'Listado', '', '2017-08-13 00:15:11'),
(45, 1, 3, 2, 'Listado', '', '2017-08-13 00:15:17'),
(46, 1, 3, 2, 'Listado', '', '2017-08-13 00:15:22'),
(47, 1, 3, 2, 'Listado', '', '2017-08-13 00:15:26'),
(48, 1, 3, 2, 'Listado', '', '2017-08-13 00:15:35'),
(49, 1, 3, 2, 'Listado', '', '2017-08-13 00:15:41'),
(50, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:04'),
(51, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:08'),
(52, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:15'),
(53, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:23'),
(54, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:33'),
(55, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:41'),
(56, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:53'),
(57, 1, 3, 2, 'Listado', '', '2017-08-13 00:16:58'),
(58, 1, 3, 2, 'Listado', '', '2017-08-13 00:17:06'),
(59, 1, 3, 2, 'Listado', '', '2017-08-13 00:17:23'),
(60, 1, 3, 2, 'Listado', '', '2017-08-13 00:17:28'),
(61, 1, 3, 2, 'Listado', '', '2017-08-13 00:17:33'),
(62, 1, 3, 2, 'Listado', '', '2017-08-13 00:17:42'),
(63, 1, 3, 2, 'Listado', '', '2017-08-13 00:17:53'),
(64, 1, 3, 2, 'Listado', '', '2017-08-13 00:18:00'),
(65, 1, 3, 2, 'Listado', '', '2017-08-13 00:18:53'),
(66, 1, 3, 2, 'Listado', '', '2017-08-13 00:19:03'),
(67, 1, 3, 2, 'Listado', '', '2017-08-13 00:19:14'),
(68, 1, 3, 2, 'Listado', '', '2017-08-13 00:19:22'),
(69, 1, 3, 2, 'Listado', '', '2017-08-13 00:19:31'),
(70, 1, 3, 2, 'Listado', '', '2017-08-13 00:19:38'),
(71, 1, 3, 2, 'Listado', '', '2017-08-13 00:19:52'),
(72, 1, 3, 2, 'Listado', '', '2017-08-13 00:20:09'),
(73, 1, 3, 2, 'Listado', '', '2017-08-13 00:20:25'),
(74, 1, 3, 2, 'Listado', '', '2017-08-13 00:20:32'),
(75, 1, 3, 2, 'Listado', '', '2017-08-13 00:21:22'),
(76, 1, 3, 2, 'Listado', '', '2017-08-13 00:22:00'),
(77, 1, 3, 2, 'Listado', '', '2017-08-13 00:40:58'),
(78, 1, 3, 2, 'Listado', '', '2017-08-13 00:42:51'),
(79, 1, 3, 2, 'Listado', '', '2017-08-13 00:42:59'),
(80, 1, 3, 2, 'Listado', '', '2017-08-13 00:43:06'),
(81, 1, 3, 2, 'Listado', '', '2017-08-13 00:43:37'),
(82, 1, 3, 2, 'Listado', '', '2017-08-13 00:44:05'),
(83, 1, 3, 2, 'Listado', '', '2017-08-13 00:44:13'),
(84, 1, 3, 2, 'Listado', '', '2017-08-13 00:45:05'),
(85, 1, 3, 2, 'Listado', '', '2017-08-13 00:45:16'),
(86, 1, 3, 2, 'Listado', '', '2017-08-13 00:45:51'),
(87, 1, 3, 2, 'Listado', '', '2017-08-13 00:46:01'),
(88, 1, 3, 2, 'Listado', '', '2017-08-13 04:10:16'),
(89, 1, 3, 2, 'Listado', '', '2017-08-13 04:11:27'),
(90, 1, 3, 2, 'Listado', '', '2017-08-13 04:11:42'),
(91, 1, 3, 2, 'Listado', '', '2017-08-13 04:11:57'),
(92, 1, 3, 2, 'Listado', '', '2017-08-13 04:55:03'),
(93, 1, 3, 2, 'Listado', '', '2017-08-13 04:55:12'),
(94, 1, 3, 2, 'Listado', '', '2017-08-13 05:09:51'),
(95, 1, 3, 2, 'Listado', '', '2017-08-13 05:13:00'),
(96, 1, 3, 2, 'Listado', '', '2017-08-13 05:13:06'),
(97, 1, 3, 2, 'Listado', '', '2017-08-13 05:23:22'),
(98, 1, 3, 2, 'Listado', '', '2017-08-13 05:23:25'),
(99, 1, 3, 2, 'Listado', '', '2017-08-13 05:23:34'),
(100, 1, 3, 2, 'Listado', '', '2017-08-13 05:23:39'),
(101, 1, 3, 2, 'Listado', '', '2017-08-13 05:24:30'),
(102, 1, 3, 2, 'Listado', '', '2017-08-13 05:24:40'),
(103, 1, 3, 2, 'Listado', '', '2017-08-13 05:24:52'),
(104, 1, 3, 2, 'Listado', '', '2017-08-13 05:25:08'),
(105, 1, 3, 2, 'Listado', '', '2017-08-13 05:25:38'),
(106, 1, 3, 2, 'Listado', '', '2017-08-13 05:25:44'),
(107, 1, 3, 2, 'Listado', '', '2017-08-13 05:25:58'),
(108, 1, 3, 2, 'Listado', '', '2017-08-13 05:26:04'),
(109, 1, 3, 2, 'Listado', '', '2017-08-13 05:26:18'),
(110, 1, 3, 2, 'Listado', '', '2017-08-13 05:26:27'),
(111, 1, 3, 2, 'Listado', '', '2017-08-13 05:26:49'),
(112, 1, 3, 2, 'Listado', '', '2017-08-13 05:26:55'),
(113, 1, 3, 2, 'Listado', '', '2017-08-13 05:27:17'),
(114, 1, 3, 2, 'Listado', '', '2017-08-13 05:27:26'),
(115, 1, 3, 2, 'Listado', '', '2017-08-13 05:28:17'),
(116, 1, 3, 2, 'Listado', '', '2017-08-13 05:28:24'),
(117, 1, 3, 2, 'Listado', '', '2017-08-13 05:28:29'),
(118, 1, 3, 2, 'Listado', '', '2017-08-13 05:28:33'),
(119, 1, 3, 2, 'Listado', '', '2017-08-13 06:08:32'),
(120, 1, 3, 2, 'Listado', '', '2017-08-13 06:10:04'),
(121, 1, 3, 2, 'Listado', '', '2017-08-13 06:10:30'),
(122, 1, 3, 2, 'Listado', '', '2017-08-13 06:10:48'),
(123, 1, 3, 2, 'Listado', '', '2017-08-13 06:11:23'),
(124, 1, 3, 2, 'Listado', '', '2017-08-13 06:11:28'),
(125, 1, 3, 2, 'Listado', '', '2017-08-13 06:11:31'),
(126, 1, 3, 2, 'Listado', '', '2017-08-13 06:11:57'),
(127, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:15'),
(128, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:22'),
(129, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:26'),
(130, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:29'),
(131, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:33'),
(132, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:37'),
(133, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:46'),
(134, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:50'),
(135, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:53'),
(136, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:57'),
(137, 1, 3, 2, 'Listado', '', '2017-08-13 06:12:59'),
(138, 1, 3, 2, 'Listado', '', '2017-08-13 06:13:25'),
(139, 1, 3, 2, 'Listado', '', '2017-08-13 06:13:48'),
(140, 1, 3, 2, 'Listado', '', '2017-08-13 06:14:06'),
(141, 1, 3, 2, 'Listado', '', '2017-08-13 06:15:15'),
(142, 1, 3, 2, 'Listado', '', '2017-08-13 06:15:44'),
(143, 1, 3, 2, 'Listado', '', '2017-08-13 06:15:49'),
(144, 1, 3, 2, 'Listado', '', '2017-08-13 06:15:55'),
(145, 1, 3, 2, 'Listado', '', '2017-08-13 06:16:07'),
(146, 1, 3, 2, 'Listado', '', '2017-08-13 06:16:15'),
(147, 1, 3, 2, 'Listado', '', '2017-08-13 06:16:18'),
(148, 1, 3, 2, 'Listado', '', '2017-08-13 06:16:25'),
(149, 1, 3, 2, 'Listado', '', '2017-08-13 06:16:44'),
(150, 1, 3, 2, 'Listado', '', '2017-08-13 06:33:08'),
(151, 1, 3, 2, 'Listado', '', '2017-08-13 06:33:17'),
(152, 1, 3, 2, 'Listado', '', '2017-08-13 06:33:28'),
(153, 1, 3, 2, 'Listado', '', '2017-08-14 16:53:24'),
(154, 1, 3, 2, 'Listado', '', '2017-08-14 17:16:50'),
(155, 1, 3, 2, 'Listado', '', '2017-08-14 17:16:58'),
(156, 1, 3, 2, 'Listado', '', '2017-08-14 17:17:01'),
(157, 1, 3, 2, 'Listado', '', '2017-08-14 17:17:11'),
(158, 1, 3, 2, 'Listado', '', '2017-08-14 17:17:40'),
(159, 1, 3, 2, 'Listado', '', '2017-08-14 17:17:53'),
(160, 1, 3, 2, 'Listado', '', '2017-08-14 17:17:59'),
(161, 1, 3, 2, 'Listado', '', '2017-08-14 17:18:23'),
(162, 1, 3, 2, 'Listado', '', '2017-08-14 17:18:33'),
(163, 1, 3, 2, 'Listado', '', '2017-08-14 17:18:51'),
(164, 1, 3, 2, 'Listado', '', '2017-08-14 17:19:17'),
(165, 1, 3, 2, 'Listado', '', '2017-08-14 17:23:10'),
(166, 1, 3, 2, 'Listado', '', '2017-08-14 17:25:20'),
(167, 1, 3, 24, 'Listado', '', '2017-08-14 17:25:22'),
(168, 1, 3, 2, 'Listado', '', '2017-08-14 17:25:38'),
(169, 1, 3, 2, 'Listado', '', '2017-08-14 17:25:55'),
(170, 1, 3, 2, 'Listado', '', '2017-08-14 17:57:44'),
(171, 1, 3, 2, 'Listado', '', '2017-08-14 18:00:00'),
(172, 1, 3, 2, 'Listado', '', '2017-08-14 18:00:42'),
(173, 1, 3, 2, 'Listado', '', '2017-08-14 18:01:09'),
(174, 1, 3, 2, 'Listado', '', '2017-08-14 18:02:58'),
(175, 1, 3, 2, 'Listado', '', '2017-08-14 18:03:07'),
(176, 1, 3, 2, 'Listado', '', '2017-08-14 18:03:18'),
(177, 1, 3, 2, 'Listado', '', '2017-08-14 18:06:21'),
(178, 1, 3, 2, 'Listado', '', '2017-08-14 18:06:43'),
(179, 1, 3, 2, 'Listado', '', '2017-08-14 18:07:10'),
(180, 1, 3, 2, 'Listado', '', '2017-08-14 18:09:07'),
(181, 1, 3, 2, 'Listado', '', '2017-08-14 18:09:28'),
(182, 1, 3, 2, 'Listado', '', '2017-08-14 18:09:35'),
(183, 1, 3, 2, 'Listado', '', '2017-08-14 18:10:03'),
(184, 1, 3, 2, 'Listado', '', '2017-08-14 18:10:33'),
(185, 1, 3, 2, 'Listado', '', '2017-08-14 18:12:14'),
(186, 1, 3, 2, 'Listado', '', '2017-08-14 18:27:41'),
(187, 1, 3, 2, 'Listado', '', '2017-08-14 19:03:52'),
(188, 1, 3, 2, 'Listado', '', '2017-08-14 19:04:04'),
(189, 1, 3, 2, 'Listado', '', '2017-08-14 19:04:39'),
(190, 1, 3, 2, 'Listado', '', '2017-08-14 21:19:19'),
(191, 1, 3, 2, 'Listado', '', '2017-08-14 21:24:45'),
(192, 1, 3, 2, 'Listado', '', '2017-08-14 21:31:48'),
(193, 1, 3, 2, 'Listado', '', '2017-08-14 21:32:04'),
(194, 1, 3, 2, 'Listado', '', '2017-08-14 21:38:27'),
(195, 1, 3, 2, 'Listado', '', '2017-08-14 21:38:48'),
(196, 1, 3, 2, 'Listado', '', '2017-08-14 21:40:08'),
(197, 1, 3, 2, 'Listado', '', '2017-08-14 21:40:59'),
(198, 1, 3, 2, 'Listado', '', '2017-08-14 21:41:25'),
(199, 1, 3, 2, 'Listado', '', '2017-08-14 21:42:03'),
(200, 1, 3, 2, 'Listado', '', '2017-08-14 21:44:55'),
(201, 1, 3, 2, 'Listado', '', '2017-08-14 21:45:06'),
(202, 1, 3, 2, 'Listado', '', '2017-08-14 21:45:16'),
(203, 1, 3, 2, 'Listado', '', '2017-08-14 21:45:21'),
(204, 1, 3, 2, 'Listado', '', '2017-08-14 21:45:29'),
(205, 1, 3, 2, 'Listado', '', '2017-08-14 21:45:42'),
(206, 1, 3, 2, 'Listado', '', '2017-08-14 21:46:41'),
(207, 1, 3, 2, 'Listado', '', '2017-08-14 21:46:56'),
(208, 1, 3, 2, 'Listado', '', '2017-08-14 21:47:12'),
(209, 1, 3, 2, 'Listado', '', '2017-08-14 21:47:31'),
(210, 1, 3, 2, 'Listado', '', '2017-08-14 21:47:44'),
(211, 1, 3, 2, 'Listado', '', '2017-08-14 21:50:15'),
(212, 1, 3, 2, 'Listado', '', '2017-08-14 21:55:18'),
(213, 1, 3, 2, 'Listado', '', '2017-08-14 21:55:38'),
(214, 1, 3, 2, 'Listado', '', '2017-08-14 21:56:05'),
(215, 1, 3, 2, 'Listado', '', '2017-08-14 21:56:19'),
(216, 1, 3, 2, 'Listado', '', '2017-08-14 22:40:19'),
(217, 1, 3, 4, 'Listado', '', '2017-08-15 00:16:33'),
(218, 1, 3, 4, 'Listado', '', '2017-08-15 00:22:57'),
(219, 1, 3, 4, 'Listado', '', '2017-08-15 00:38:22'),
(220, 1, 3, 2, 'Listado', '', '2017-08-15 00:38:28'),
(221, 1, 3, 2, 'Listado', '', '2017-08-15 00:38:45'),
(222, 1, 3, 2, 'Listado', '', '2017-08-15 00:38:51'),
(223, 1, 3, 2, 'Listado', '', '2017-08-15 00:39:03'),
(224, 1, 3, 2, 'Listado', '', '2017-08-15 00:39:08'),
(225, 1, 3, 2, 'Listado', '', '2017-08-15 00:39:13'),
(226, 1, 3, 2, 'Listado', '', '2017-08-15 00:39:23'),
(227, 1, 3, 2, 'Listado', '', '2017-08-15 00:39:47'),
(228, 1, 3, 2, 'Listado', '', '2017-08-15 00:39:57'),
(229, 1, 3, 2, 'Listado', '', '2017-08-15 00:40:03'),
(230, 1, 3, 2, 'Listado', '', '2017-08-15 00:40:14'),
(231, 1, 3, 2, 'Listado', '', '2017-08-15 00:40:30'),
(232, 1, 3, 2, 'Listado', '', '2017-08-15 00:40:41'),
(233, 1, 3, 2, 'Listado', '', '2017-08-15 00:40:55'),
(234, 1, 3, 2, 'Listado', '', '2017-08-15 00:42:24'),
(235, 1, 3, 2, 'Listado', '', '2017-08-15 00:42:48'),
(236, 1, 3, 2, 'Listado', '', '2017-08-15 00:43:47'),
(237, 1, 3, 2, 'Listado', '', '2017-08-15 00:44:04'),
(238, 1, 3, 2, 'Listado', '', '2017-08-15 00:44:17'),
(239, 1, 3, 2, 'Listado', '', '2017-08-15 03:18:56'),
(240, 1, 3, 2, 'Listado', '', '2017-08-15 03:32:37'),
(241, 1, 3, 7, 'Listado', '', '2017-08-15 04:04:00'),
(242, 1, 3, 2, 'Listado', '', '2017-08-15 04:04:05'),
(243, 1, 3, 4, 'Listado', '', '2017-08-15 04:04:14'),
(244, 1, 3, 4, 'Consultar', '{CÃ³digo:\'7\'}', '2017-08-15 04:04:19'),
(245, 1, 3, 4, 'Listado', '', '2017-08-15 04:23:26'),
(246, 1, 1, 4, 'toastr.info(\'Registro agregado exitosamente\',\'\',{progressBar:true})', '{CÃ³digo:\'\',Modulo:\'21\',Nombre:\'Noticias\',URL:\'noticie\',Icono:\'782\',Color de letra:\'F5F5F5\'}', '2017-08-15 04:23:59'),
(247, 1, 3, 7, 'Listado', '', '2017-08-15 04:24:07'),
(248, 1, 3, 7, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-15 04:24:10'),
(249, 1, 2, 7, 'toastr.info(\'Registro modificado exitosamente\',\'\',{progressBar:true})', '', '2017-08-15 04:24:30'),
(250, 1, 3, 7, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-15 04:24:30'),
(251, 1, 3, 7, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-15 04:24:46'),
(252, 1, 3, 4, 'Listado', '', '2017-08-15 04:24:53'),
(253, 1, 3, 4, 'Consultar', '{CÃ³digo:\'30\'}', '2017-08-15 04:24:56'),
(254, 1, 2, 4, 'toastr.info(\'Registro modificado exitosamente\',\'\',{progressBar:true})', '{CÃ³digo:\'30\',Modulo:\'21\',Nombre:\'Noticias\',URL:\'notice\',Icono:\'782\',Color de letra:\'F5F5F5\'}', '2017-08-15 04:25:02'),
(255, 1, 3, 4, 'Consultar', '{CÃ³digo:\'30\'}', '2017-08-15 04:25:02'),
(256, 1, 3, 2, 'Listado', '', '2017-08-15 04:25:05'),
(257, 1, 1, 2, 'toastr.info(\'Registro agregado exitosamente\',\'\',{progressBar:true})', '{CÃ³digo:\'\',notice_name:\'\'}', '2017-08-15 04:25:16'),
(258, 1, 3, 2, 'Listado', '', '2017-08-15 04:25:19'),
(259, 1, 3, 2, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-15 04:25:23'),
(260, 1, 2, 2, 'toastr.info(\'Registro modificado exitosamente\',\'\',{progressBar:true})', '{CÃ³digo:\'\',Titulo:\'\',Contenido:\'Nuevo hola mundos\'}', '2017-08-15 04:25:26'),
(261, 1, 3, 2, 'Consultar', '{CÃ³digo:\'\'}', '2017-08-15 04:25:26'),
(262, 1, 3, 2, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-15 04:25:29'),
(263, 1, 3, 2, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-15 04:25:37'),
(264, 1, 2, 2, 'toastr.info(\'Registro modificado exitosamente\',\'\',{progressBar:true})', '{CÃ³digo:\'1\',Titulo:\'\',Contenido:\'Nuevo hola mundox\'}', '2017-08-15 04:25:41'),
(265, 1, 3, 2, 'Consultar', '{CÃ³digo:\'1\'}', '2017-08-15 04:25:41'),
(266, 1, 3, 2, 'Listado', '', '2017-08-15 04:25:43'),
(267, 1, 3, 2, 'Listado', '', '2017-08-15 04:38:57');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acms_tlog_report`
--

CREATE TABLE `acms_tlog_report` (
  `idlog_report` int(11) NOT NULL,
  `iduser` int(11) NOT NULL,
  `report` text COLLATE utf8_spanish_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `acms_tnationality`
--

CREATE TABLE `acms_tnationality` (
  `idnationality` int(11) NOT NULL,
  `name_one` varchar(3) COLLATE utf8_spanish_ci NOT NULL,
  `name_two` varchar(25) COLLATE utf8_spanish_ci NOT NULL,
  `status` char(1) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `acms_tnationality`
--

INSERT INTO `acms_tnationality` (`idnationality`, `name_one`, `name_two`, `status`) VALUES
(1, 'V', 'Venezolano', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acms_tnotice`
--
...
--
-- Estructura de tabla para la tabla `acms_torganization`
--

CREATE TABLE `acms_torganization` (
  `name_one` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `name_two` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `email` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `description` text COLLATE utf8_spanish_ci NOT NULL,
  `idgallery_header` int(11) NOT NULL,
  `idgallery_favicon` int(11) NOT NULL,
  `address` text COLLATE utf8_spanish_ci NOT NULL,
  `rights` text COLLATE utf8_spanish_ci NOT NULL,
  `phone_one` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `phone_two` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `phone_three` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `number_question_answer` int(11) DEFAULT NULL,
  `login` int(11) DEFAULT NULL,
  `new_password_sent_email` int(11) DEFAULT NULL,
  `email_host` text COLLATE utf8_spanish_ci,
  `email_port` varchar(5) COLLATE utf8_spanish_ci DEFAULT NULL,
  `email_security_smtp` char(1) COLLATE utf8_spanish_ci DEFAULT NULL,
  `email_type_security_smtp` varchar(3) COLLATE utf8_spanish_ci DEFAULT NULL,
  `email_user` text COLLATE utf8_spanish_ci,
  `email_password` text COLLATE utf8_spanish_ci,
  `email_subject` text COLLATE utf8_spanish_ci,
  `email_message` text COLLATE utf8_spanish_ci,
  `number_days_password_diferrence` int(11) DEFAULT NULL,
  `number_answer_allowed` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `acms_torganization`
--

INSERT INTO `acms_torganization` (`name_one`, `name_two`, `email`, `description`, `idgallery_header`, `idgallery_favicon`, `address`, `rights`, `phone_one`, `phone_two`, `phone_three`, `number_question_answer`, `login`, `new_password_sent_email`, `email_host`, `email_port`, `email_security_smtp`, `email_type_security_smtp`, `email_user`, `email_password`, `email_subject`, `email_message`, `number_days_password_diferrence`, `number_answer_allowed`) VALUES
...
--
-- Estructura de tabla para la tabla `acms_tpage`
--
...
--
-- Estructura de tabla para la tabla `acms_tperson`
--
...
CREATE TABLE `acms_tperson` (
  ...
  `identification_card` varchar(15) COLLATE utf8_spanish_ci NOT NULL,
  `name_one` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `name_two` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `last_name_one` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `last_name_two` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `sex` char(1) COLLATE utf8_spanish_ci NOT NULL,
  `email` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `birth_date` date NOT NULL,
  `birth_place` text COLLATE utf8_spanish_ci NOT NULL,
  `idaddress` int(11) NOT NULL,
  `address` text COLLATE utf8_spanish_ci NOT NULL,
  `phone_one` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `phone_two` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
...
--
-- Volcado de datos para la tabla `acms_tperson`
--

INSERT INTO `acms_tperson` (`idperson`, `idnationality`, `idethnicity`, `idcharge`, `image`, `identification_card`, `name_one`, `name_two`, `last_name_one`, `last_name_two`, `sex`, `email`, `birth_date`, `birth_place`, `idaddress`, `address`, `phone_one`, `phone_two`, `status`) VALUES
(1, 1, 1, 1, '', '00000000', 'Administrador', '', 'Root', '', 'F', 'augustoalvarez05@gmail.com', '2017-08-11', 'asad', 1036, '', '', '', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acms_tpost`
--
...
CREATE TABLE `acms_tpost` (
  ...
  `name` text COLLATE utf8_spanish_ci NOT NULL,
  `color` char(7) COLLATE utf8_spanish_ci NOT NULL,
  `idgallery` int(11) NOT NULL,
  `content` text COLLATE utf8_spanish_ci NOT NULL,
  `iduser` int(11) NOT NULL,
  `date_created` date NOT NULL,
...
--
-- Volcado de datos para la tabla `acms_tpost`
--

INSERT INTO `acms_tpost` (`idpost`, `url`, `name`, `color`, `idgallery`, `content`, `iduser`, `date_created`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `acms_tservice`
--
...
--
-- Volcado de datos para la tabla `acms_tservice`
--
...
(26, 1, 'Configuracion', 'configuration', 124, 'F5F5F5', '1'),
...
--
-- Estructura de tabla para la tabla `acms_tsocial_network`
--
...
--
-- Estructura de tabla para la tabla `acms_ttemplate`
--

CREATE TABLE `acms_ttemplate` (
  `idtemplate` int(11) NOT NULL,
  `fields` text COLLATE utf8_spanish_ci NOT NULL,
  `data` text COLLATE utf8_spanish_ci NOT NULL,
  `status` char(1) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Estructura de tabla para la tabla `acms_tuser`
--
...
--
-- Volcado de datos para la tabla `acms_tuser`
--

INSERT INTO `acms_tuser` (`iduser`, `idperson`, `name`, `failed_attempts`, `initiated`, `note`, `status`) VALUES
(1, 1, 'admin', 0, 1, 'asdasdasdasfsafas', '1');
...
--
-- Indices de la tabla `acms_ttemplate`
--
ALTER TABLE `acms_ttemplate`
...
--
ALTER TABLE `acms_tdcharge_service_action`
  MODIFY `idcharge_service_action` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5529;
--
...
--
ALTER TABLE `acms_tdservice_action`
  MODIFY `idservice_action` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239;
--
...
--
ALTER TABLE `acms_tlog_access`
  MODIFY `idlog_access` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT de la tabla `acms_tlog_movement`
--
ALTER TABLE `acms_tlog_movement`
  MODIFY `idlog_movement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=268;
--
...
--
ALTER TABLE `acms_tservice`
  MODIFY `idservice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
-- AUTO_INCREMENT de la tabla `acms_ttemplate`
--
ALTER TABLE `acms_ttemplate`
