...
class ethnicityModel{
	...
	public function listt($draw,$search,$start,$length){
		...
		$this->db->prepare("SELECT *,(SELECT count(*) FROM ".PREFIX."tethnicity) as countx FROM ".PREFIX."tethnicity WHERE idethnicity LIKE '%$search%' OR name LIKE '%$search%' ORDER BY idethnicity DESC LIMIT $start,$length ");
