...
<div class="box">
	<div class="box-tools">
		<div class="box-tool-left">
			<a href="<?=url_base?>home/dashboard"><?=dashboard?></a> <i class="fa fa-angle-right"></i> <a href="<?=url_base.controller?>"><?=person?></a> <?=(action!="index")? "<i class='fa fa-angle-right'></i> ".((action=="add")? add : ((action=="edit")? edit : query ) ) : ''?>
		</div>
	...
	<div class="box-container">
		...
		<?php }else{ ?>
			<?=(action!="query")? "<form name='hola' action='".url_base.controller."/".action."/".$d["idperson"]."' method='POST' class='form-horizontal' enctype='multipart/form-data'>" : "<div class='form-horizontal'>" ?>
