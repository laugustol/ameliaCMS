	...
	<div class="box-container">
		<form action='<?=url_base.controller."/".action?>' method='POST' class='form-horizontal' enctype='multipart/form-data'>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" id="nationality" value="<?=$d[0]["nationality"]?>" aajs='searchajax{<?=url_base?>nationality/search,this},required' class="width-full" data-toggle="tooltip" title="<?=person_idnationality_title?>" placeholder="<?=person_idnationality_placeholder?>" autocomplete="off">
						<input type="hidden" name="idnationality" id="idnationality" value="<?=$d[0]["idnationality"]?>" aajs='required'>
					</div>
