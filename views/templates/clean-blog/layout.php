...
<head>
    ...
    <link href="<?=url_base?>views/templates/clean-blog/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?=url_base?>views/templates/clean-blog/css/clean-blog.min.css" rel="stylesheet">
    <link href="<?=url_base?>views/templates/clean-blog/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    ?>
                    <?=($cfg["login"]=="1")? "<li><a href='".url_base."home/login'>".template_login."</a></li>" : ''?>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <?php 
                require "views/templates/clean-blog/".$view;
            ?>
        </div>
    </div>
    <hr>
    ...
    <script src="<?=url_base?>views/templates/clean-blog/vendor/jquery/jquery.min.js"></script>
    <script src="<?=url_base?>views/templates/clean-blog/vendor/bootstrap/js/bootstrap.min.js"></script>
    <script src="<?=url_base?>views/templates/clean-blog/js/jqBootstrapValidation.js"></script>
    <script src="<?=url_base?>views/templates/clean-blog/js/contact_me.js"></script>
    <script src="<?=url_base?>views/templates/clean-blog/js/clean-blog.min.js"></script>
</body>
</html>
